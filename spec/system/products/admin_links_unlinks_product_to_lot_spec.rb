...
describe 'Admin links/unlinks a product to/from a lot' do
  context 'when a lot is awaiting approval' do
    ...
    context 'and is not expired' do
      ...
      it 'should set the product status to unavailable after the link' do
        admin_user = User.create!(
          name: 'John Doe', cpf: '41760209031',
          email: 'john@leilaodogalpao.com.br', password: 'password123'
        )
      ...
      it 'should set the product status to available after the unlink' do
        admin_user = User.create!(
          name: 'John Doe', cpf: '41760209031',
          email: 'john@leilaodogalpao.com.br', password: 'password123'
        )
